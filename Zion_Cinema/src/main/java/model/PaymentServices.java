...
public class PaymentServices {
    ...
    public String authorizePayment(OrderDetail orderDetail)        
        ...
        // Use com.paypal.api.payments.Transaction from PayPal SDK
        List<com.paypal.api.payments.Transaction> listTransaction = getTransactionInformation(orderDetail);
    ...
    // Return List of com.paypal.api.payments.Transaction (PayPal type)
    private List<com.paypal.api.payments.Transaction> getTransactionInformation(OrderDetail orderDetail) {
        ...
        details.setShipping(String.format("%.2f", vat)); // Using VAT as "shipping"
        ...
        if (orderDetail.getTotalTicketPrice() > 0) {
            ...
            ticketItem.setName("Tickets for: " + orderDetail.getMovieName());
        ...
        List<com.paypal.api.payments.Transaction> listTransaction = new ArrayList<>();
